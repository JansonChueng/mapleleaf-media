    ...
    <section id="studio" className="relative py-24 lg:py-36 overflow-hidden flex justify-center">
      ...
      <div className="relative z-20 w-full max-w-[80rem] px-6 lg:px-12">
        <SectionTitle
          ...
          title="自有影棚，高效迎合拍摄需求"
          subtitle="深圳龙华 100㎡ 自营影棚 + 200m 内 6 大主题场景，下楼即拍，零交通成本"
          light
        />
        ...
        >
          <div className="text-center py-8 border-r border-white/[0.06]">
            <p className="font-display font-bold text-3xl lg:text-4xl text-white">100<span className="text-maple-red">㎡</span></p>
          ...
          <div className="text-center py-8">
            <p className="font-display font-bold text-3xl lg:text-4xl text-white">200<span className="text-maple-red">m</span></p>
            <p className="font-mono text-[11px] text-white/40 tracking-[0.1em] uppercase mt-2">下楼即拍</p>
          </div>
        </motion.div>
      </div>
    </section>
